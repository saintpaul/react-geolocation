...
var _initialiseProps = function _initialiseProps() {
    ...
    this._getUserInputAddressFromProps = function (props) {
        var userInputAddress = _get("value.userInputAddress")(props) || _get("value.userInputAddress")(_this3.state);
        if (userInputAddress && userInputAddress !== "") return userInputAddress;else return _get("value.gmapsAddress")(_this3.props) || "";
    };
